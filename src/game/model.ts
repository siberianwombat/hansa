...
export const initPlayersState = (players: { [key in Color]?: string }) => {
  ...
  var orderHandicapTokens = 0;
  shuffledPlayers.forEach(player => {
    player.personalSupply.t += orderHandicapTokens;
    player.generalStock.t -= orderHandicapTokens;
    orderHandicapTokens++;
  });
